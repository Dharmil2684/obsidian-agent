...
- [x] **Phase 4** — Settings panel (vault path, model, backups), `/settings` + `/refresh-context` + `/first-run` endpoints, vault scanner auto-update, onboarding welcome on first run, 113 tests total
